<nav
	class="fixed z-30 w-full  border-b border-gray-200 dark:bg-gray-800 dark:border-gray-700" style="background-color: #448DBA;"
>
	<div class="px-3 py-3 lg:px-5 lg:pl-3">
		<div class="flex items-center justify-between">
           ...
           <span class="mt-1 text-white">Nguyễn Tú</span> 
          
            <svg class="w-[19px] h-[19px] text-gray-800 text-white ml-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 18 15">
